...
text(100, 0.14, 'p1/\sigma = 0.88, \sigma/\eta = 0.00019','fontsize', 16);
% plot(f, abs(h13 - 2)/2, 'k--', 'linewidth', 1.5);

plot(f, abs(h02 - 2)/2, 'r', 'linewidth', 2);
text(200, 0.32, 'p1/\sigma = 0.88, \sigma/\eta = 0.0019','fontsize', 16);
plot(f, abs(h12 - 2)/2, 'r:', 'linewidth', 1.5);
text(180, 0.024, 'p1/\sigma = 0.088, \sigma/\eta = 0.0019','fontsize', 16);
...
ylabel('Maximum Grating Amplitude (over init height)', 'fontSize', 14, 'fontWeight', 'bold');
